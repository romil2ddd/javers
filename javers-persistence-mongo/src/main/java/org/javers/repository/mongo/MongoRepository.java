...
public class MongoRepository implements JaversRepository {
    ...
    private Bson createBulkIdQuery(final Set<GlobalId> ids) {
    ...
    private List<CdoSnapshot> getLatestSnapshots(final Bson idQuery) {
        final MongoCursor<Document> mongoLatest = getMongoSnapshotsCursor(idQuery, Optional.empty());
